...
<div class="header-container">
 ...
 <main class="header__main"> <?$APPLICATION->IncludeComponent(
	...
	false
);?><br></main> <footer class="header__footer">
	...
	<div class="product__item">
		<div class="product__slider">
			<ul class="product__season-list">
				<li class="product__season-item"> <a href="#" class="product__season-link product__season-link-active js-link">Лето</a> </li>
				<li class="product__season-item"> <a href="#" class="product__season-link js-link">Зима</a> </li>
				<li class="product__season-item"> <a href="#" class="product__season-link js-link">Mega Sport</a> </li>
				<li class="product__season-item"> <a href="#" class="product__season-link js-link">Air Statix</a> </li>
			</ul>
			<div class="product__slider-container">
				<div class="swiper-container product__slider">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
 <img src="/local/templates/sneaker/images/product__photo-big.png" class="product__slider-img--big" alt="">
						</div>
						<div class="swiper-slide">
 <img src="/local/templates/sneaker/images/product__photo-big2.png" class="product__slider-img--big" alt="">
						</div>
						<div class="swiper-slide">
 <img src="/local/templates/sneaker/images/product__photo-big3.png" class="product__slider-img--big" alt="">
						</div>
						<div class="swiper-slide">
 <img src="/local/templates/sneaker/images/product__photo-big4.png" class="product__slider-img--big" alt="">
						</div>
					</div>
				</div>
				<div class="product__thumbs">
 <img src="/local/templates/sneaker/images/product__photo-small1.png" class="product__slider-img--small js-productImgSmall" alt=""> <img src="/local/templates/sneaker/images/product__photo-small2.png" class="product__slider-img--small js-productImgSmall" alt=""> <img src="/local/templates/sneaker/images/product__photo-small3.png" class="product__slider-img--small js-productImgSmall" alt=""> <img src="/local/templates/sneaker/images/product__photo-small4.png" class="product__slider-img--small js-productImgSmall" alt="">
				</div>
				<div class="swiper__button-prev product__slider-button--prev">
				</div>
				<div class="swiper__button-next product__slider-button--next">
				</div>
			</div>
		</div>
		<div class="product__description">
			...
			<div class="product__paragraph">
				 Отличаются великолепным качеством изготовления и применением новейших технологий, появляющихся в области спортивной обуви. Сетка достаточно плотная, чтобы выдерживать высокие нагрузки, возникающие во время активных движений, например, бега, и, в то же время, достаточно крупная, чтобы обеспечить отличную вентиляцию стоп. Носок кроссовок укреплен кожей, что предохраняет обувь от потери формы и надежно фиксирует стопу
			</div>
